...
final class ResultViewController: UIViewController {
    ...
    private func setResultsToLabels() {
        resultingDefinitionEmoji.text = "Вы - \(animalsFromAnswers.mostFrequent()?.rawValue ?? "☠︎")"
        resultingDefinitionString.text = animalsFromAnswers.mostFrequent()?.definition
    }
...
/* code with private func to find frequent value
 import UIKit
